...
/**
 * Standard utility to log all inventory movements for audit trails.
 */
...
/**
 * Fetches all inventory items and their current stock levels.
 */
...
/**
 * Creates a new inventory item and initializes its stock record to 0.
 */
...
/**
 * Adjusts inventory stock levels manually (e.g., restocks, corrections).
 */
...
/**
 * Deducts stock from inventory strictly for prescriptions. Validates stock availability.
 */
...
/**
 * Returns a list of items nearing their expiration dates or already expired.
 */
...
/**
 * Returns a list of items whose stock levels have fallen at or below their configured reorder thresholds.
 */
...
/**
 * Hard deletes an inventory item and its associated stock records.
 */
