...
/**
 * Global site footer.
 * Renders quick links, contact information, and social media references.
 */
function Footer() {
  ...
  return (
    <div style={footer}>
      ...
      <div style={column}>
        ...
        <p style={footerLink} onClick={() => navigate(ROUTES.PUBLIC.SERVICES)}>
          Services
        </p>

        <p style={footerLink} onClick={() => navigate(ROUTES.AUTH.SIGNUP)}>
          Book Appointment
        </p>

        <p style={footerLink} onClick={() => navigate(ROUTES.PUBLIC.CONTACT)}>
          Contact Us
        </p>
      </div>
      ...
      <div style={column}>
        ...
        <div style={{ marginTop: "0.5rem" }}>
          ...
          <a
            ...
            style={linkStyle}
          >
            <FaFacebook size={30} style={{ marginTop: "0rem" }} />
          </a>
        </div>
      </div>
