 ...
 * Services Component
 * 
 * Displays a comprehensive list of medical and care services offered by the clinic.
 */
function Services() {
        ...
        {services.map((service, index) => (
          <div key={index} style={card}>
            ...
            <button
              style={bookBtn}
              onClick={() => {
                if (service.name === "Pet Shop") {
                  navigate(ROUTES.PUBLIC.SHOP);
                } else {
                  navigate(ROUTES.AUTH.SIGNUP);
                }
              }}
            >
              {service.name === "Pet Shop" ? "View Catalogue" : "Book"}
            </button>
          </div>
        ))}
      </div>
